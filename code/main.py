...
def initialize():
	...
	parser.add_argument('f_data', help='File path of input data to SHIMR. File format should be ".npy". \
		The file should contain data in the format of "[data_train, data_test, Feature_dict, class_labels_dict]"')
