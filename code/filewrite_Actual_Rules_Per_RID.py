...
def write_Actual_Rules_with_Diag_per_RID(f_Actual_Rules_Per_RID, X, data_test, filename_rules, result_train, pred_proba_cal, label_pred_all,filename_IS):
	RID=data_test[:,0]
	Diag=data_test[:,1]
